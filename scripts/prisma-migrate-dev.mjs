...
const exists = spawnSync(
  "psql",
  [prismaDevAdminDatabaseUrl, "-Atqc", `SELECT 1 FROM pg_database WHERE datname = '${prismaDevDatabaseName}'`],
  {
    cwd: repoRoot,
    encoding: "utf8"
  }
...
const result = run(process.execPath, [prismaCli, "migrate", "dev", ...extra], {
  ...process.env,
