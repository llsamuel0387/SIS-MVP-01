...
import StudentInformationEdit from "@/app/(portals)/studentportal/_components/student-information-edit";

export default async function StudentInformationEditPage() {
